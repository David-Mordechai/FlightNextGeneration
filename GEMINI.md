...
- **C4I Entities & Points**
  ...
  - **Technical Fixes:** 
    ...
    - **New Microservice:** Implemented `McpServer.MissionControl`, an MCP server for chat-based entity management (Create, List, Delete points).
    - **BFF Update:** Enhanced `AiChatService` to support multiple aggregated MCP servers.
    - **Entity Editing:** Implemented full edit support for Points (click to edit, drag to move). Fixed `Leaflet.Draw` crashes and artifact issues during updates.
    - **UI/UX Overhaul:**
